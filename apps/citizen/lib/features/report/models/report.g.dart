...
class ReportAdapter extends TypeAdapter<Report> {
  ...
  Report read(BinaryReader reader) {
    ...
    return Report(
      ...
      category: fields[1] == null ? '' : fields[1] as String,
      title: fields[2] == null ? '' : fields[2] as String,
      description: fields[3] == null ? '' : fields[3] as String,
      images: fields[4] == null ? const [] : (fields[4] as List).cast<String>(),
      latitude: fields[5] == null ? 0.0 : (fields[5] as num).toDouble(),
      longitude: fields[6] == null ? 0.0 : (fields[6] as num).toDouble(),
